    ...
    if (currentPage === 0) {
      return (
        <MDBPagination center className='mb-0'>
          ...
          <MDBPaginationItem>
            <MDBBtn rounded onClick={() => loadBlogsData(5, 10, 1)}>Next</MDBBtn>
          </MDBPaginationItem>
      ...
      return (<MDBPagination center className='mb-0'>
        ...
        <MDBPaginationItem>
          <MDBBtn rounded onClick={() => loadBlogsData((currentPage - 1) * 5, currentPage * 5, -1)}>Prev
          </MDBBtn>
        </MDBPaginationItem>
        ...
        <MDBPaginationItem>
          <MDBBtn rounded onClick={() => loadBlogsData((currentPage + 1) * 5, (currentPage + 2) * 5, 1)}>Next
          </MDBBtn>
        </MDBPaginationItem>
      </MDBPagination>);
      ...
      return (
        <MDBPagination center className='mb-0'>
          ...
          <MDBPaginationItem>
            <MDBBtn
              rounded
              onClick={() => loadBlogsData((currentPage - 1) * 5, currentPage * 5, -1)}>Prev
            </MDBBtn>
          </MDBPaginationItem>
